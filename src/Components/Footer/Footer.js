        ...
        <div className="footer-logo-container">
          ...
          <div className="footer-logo-para">
            <p className="footer-text">
              A financial startup that is building a platform that will let
              users import there financial data from different platforms and
              creat a financial dashboard
            </p>
          </div>
