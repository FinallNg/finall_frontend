    ...
    <div className="help-container">
      ...
      <div className="help-box">
        <div className="help-box1">
          ...
          <p className="help-text2">
            How to contact our support
            <br /> team in case you need any
            <br /> help
          </p>
        </div>
        ...
        <div className="help-box1">
          ...
          <p className="help-text2">
            What is Finall,Who is Finall <br /> For features and everything
            <br /> you need to know
          </p>
        </div>
        ...
        <div className="help-box1">
          ...
          <p className="help-text2">
            List of supported banks and <br /> cards and how to connect <br />{" "}
            them to your Finall account
          </p>
        </div>
      </div>
      <div className="help-box">
        <div className="help-box1">
          ...
          <p className="help-text2">
            Having difficlties connecting <br /> accounts? See why. <br />
          </p>
        </div>
        <div className="help-box1">
          <h5 className="help-tag2">Finall Account</h5>
          <p className="help-text2">
            How to create,delete,import <br />
            and export data and more. <br />
          </p>
        </div>
        <div className="help-box1">
          <h5 className="help-tag2">Subscriptions</h5>
          <p className="help-text2">
            Finall free and Premium <br />
            accounts, and all the goodies. <br />
          </p>
        </div>
      </div>
    </div>
