        ...
        <div className='invoices2-content'>
          <div className='invoices2-content1'>
            <div className='invoices2-content1-box'>
              <form>
                <input name='search' type='search'  placeholder=' Search for an invoice'></input>
              </form>
              <div className='invoices2-box-details'>
                ...
                <div className='invoices2-box-line second'>
                  <div className='invoices2-line2-left '><h6>Shopping</h6></div>
                  <div className='invoices2-line2-right'><h6>13 Dec 2020</h6></div>
                </div>
              </div>
              <div className='invoices2-box-details'>
                <div className='invoices2-box-line first'>
                ...
                <div className='invoices2-box-line second'>
                  <div className='invoices2-line2-left '><h6>food</h6></div>
                  <div className='invoices2-line2-right'><h6>07 Dec 2020</h6></div>
                </div>
              </div>
              <div className='invoices2-box-details'>
                <div className='invoices2-box-line first'>
                ...
                <div className='invoices2-box-line second'>
                  <div className='invoices2-line2-left '><h6>Shopping</h6></div>
                  <div className='invoices2-line2-right'><h6>14 Dec 2020</h6></div>
                </div>
              </div>
              <div className='invoices2-box-details'>
                <div className='invoices2-box-line first'>
            ...
            <div className='invoices2-content2-box'>
              ...
              <div className='content2-box-details'>
                ...
                <div className='box-details-2'>
                  <div className='details2-percentage-bar'>
              ...
              <div className='invoice-no-box'>
                <div className='invoice-no-content'>
                  <div className='invoice-no-details'>
                    <div className='invoice-no-h1'><h6>Invoice number</h6></div>
                  ...
                  <div className='invoice-no-details'>
                    <div className='invoice-no-h1'><h6>Inv -1-12/20</h6></div>
                    <div className='invoice-no-h2'>
                      <div className='invoice-no-img'>
                  ...
                  <div className='invoice-no-details'>
                    <div className='invoice-no-h1'><h6>Issued Date: 14 Dec, 2020</h6></div>
                    <div className='invoice-no-h2'>
