...
export const Amount = () =>{
  return(
    ...
    <p className="Am">Amount Due (USD)</p><br></br>
    <h1 className="tax">$48,0000<span className="spin">(Tax incl)</span></h1><br></br>
    <button className="Due"><b>Due on Jan 30,2023</b></button>
